  ...
  return (
    <div>
      ...
      <p>
        ...
        consolidate those build steps into a single command.{" "}
        <b>
          Using loaders, we can convert code and assets from one format into
          another
        </b>
        . There are loaders for pretty much anything you can think of:
        Typescript to JavaScript, ES6 JavaScript to legacy style JavaScript,
        LESS to CSS, and even loaders that allow you to convert SVG images to
        first class React components.
      </p>
      <CodeViewer tabs={tabs} />
      <p>
        One interesting thing to note is the{" "}
        <b>precedence order of the loaders</b> used in a given rule - it works
